...
gdjs.loadingCode.asyncCallback9187236 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.loadingCode.asyncCallback9187236(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.loadingCode.asyncCallback9186476 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.loadingCode.asyncCallback9186476(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.loadingCode.asyncCallback9186276 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.loadingCode.asyncCallback9186276(runtimeScene, asyncObjectsList)));
}
}
